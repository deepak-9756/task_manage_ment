...
import 'package:task_manage_ment/views/signup_page.dart';
...
class LoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [SizedBox(height: 50), Text("Login Page"), _authForm()],
      ),
    );
  }
        ...
        children: [
          ...
          TextButton(
            onPressed: () async {
              ...
              if (await controller.login()) Get.offAll(MyHomePage());
            },
            child: Text("Login Up"),
          ),
